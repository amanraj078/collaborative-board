                    ...
                    <>
                        <rect
                            ...
                            style={{
                                ...
                                transform: `translate(
                                    ${bounds.x - HANDLE_WIDTH / 2}px, ${bounds.y - HANDLE_WIDTH / 2}px)`,
                            }}
                            onPointerDown={(e) => {
                                e.stopPropagation();
                            }}
                        ...
                        <rect
                            ...
                            style={{
                                ...
                                height: `${HANDLE_WIDTH}px`,
                                transform: `translate(
                                    ${bounds.x + bounds.width / 2 - HANDLE_WIDTH / 2}px, ${bounds.y - HANDLE_WIDTH / 2}px
                                )`,
                            }}
                            onPointerDown={(e) => {
                                e.stopPropagation();
                        ...
                        <rect
                            ...
                            style={{
                                ...
                                height: `${HANDLE_WIDTH}px`,
                                transform: `translate(
                                    ${bounds.x - HANDLE_WIDTH / 2 + bounds.width}px, ${bounds.y - HANDLE_WIDTH / 2}px
                                )`,
                            }}
                            onPointerDown={(e) => {
                                e.stopPropagation();
                        ...
                        <rect
                            ...
                            style={{
                                ...
                                transform: `translate(
                                    ${bounds.x - HANDLE_WIDTH / 2}px, 
                                    ${bounds.y + -HANDLE_WIDTH / 2 + bounds.width / 2}px
                                )`,
                            }}
                            onPointerDown={(e) => {
                                e.stopPropagation();
